...
from utils.text.symbols import symbols, phonemes, _phoneme_punctuations, _bos, _eos, symbols_FR

# Mappings from symbol to numeric ID and vice versa:
_SYMBOL_TO_ID = {s: i for i, s in enumerate(symbols)}
_ID_TO_SYMBOL = {i: s for i, s in enumerate(symbols)}

#_SYMBOL_TO_ID = {s: i for i, s in enumerate(symbols_FR)}
#_ID_TO_SYMBOL = {i: s for i, s in enumerate(symbols_FR)}
